...
#+begin_src emacs-lisp
  ...
  (defvar *my-font* "")
  (setq *my-font* "Hack")
  (set-face-attribute 'default nil :font *my-font* :height 150)
...
#+begin_src emacs-lisp
  (use-package geiser
    ...
    :custom
      ...
      (geiser-set-default-implementation 'guile))
#+end_src
...
#+begin_src emacs-lisp
  ;; taken from here: https://ww
w.emacswiki.org/emacs/EshellMultipleEshellBuffers#:~:text=Multi%2Deshell,-multi%2Deshell.&text=It%20maintains%20a%20ring%20of,buffer%20in%20the%20shell%20ring.
  (defun eshell-new ()
